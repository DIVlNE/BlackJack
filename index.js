...
let playerEl = document.getElementById("player-el") // grab player-el paragraph and store in a variable

playerEl.textContent = player.name + ": $" + player.chips // Render the player's name and chips in playerEl
